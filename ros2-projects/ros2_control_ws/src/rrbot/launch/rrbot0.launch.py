# to view robot model in rviz2
# control the joints using the joint_state_publisher_gui
...
def generate_launch_description():
    ...
    default_model_path = rrbot_path / 'urdf/rrbot.urdf.xacro'
    ...
    rviz_config_path = '/home/ubuntu/ros2-projects/ros2_control_ws/src/rrbot/config/default.rviz'
